...
export default class Line {
    ...
    static intersect(line1, line2) {
        const tTop = (line2.end.x - line2.start.x) * (line1.start.y - line2.start.y) -
            (line2.end.y - line2.start.y) * (line1.start.x - line2.start.x);
        const uTop = (line2.start.y - line1.start.y) * (line1.start.x - line1.end.x) -
            (line2.start.x - line1.start.x) * (line1.start.y - line1.end.y);
        const bottom = (line2.end.y - line2.start.y) * (line1.end.x - line1.start.x) -
