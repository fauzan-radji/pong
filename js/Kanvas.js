...
export default class Kanvas {
    ...
    drawImage(image, point, width, height) {
        this.ctx.drawImage(image, point.x + this.right, point.y + this.bottom, width, height);
        return this;
    }
    // angle in radian
    ...
    circle(point, radius) {
        this.beginPath();
        this.ctx.arc(point.x + this.right, point.y + this.bottom, radius, 0, 2 * Math.PI);
        this.closePath();
        return this;
    }
    rect(point, width, height) {
        this.ctx.rect(point.x + this.right - width * 0.5, point.y + this.bottom - height * 0.5, width, height);
        this.closePath();
        return this;
    }
